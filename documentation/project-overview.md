...
> **Theoretical Grounding:** 36 Seminal SOTA Papers (2023–2026 SOTA Horizon)
...
4. It **synthesizes** the academic thesis in **Typst 0.11+** and **LaTeX**, referencing exclusively verified code, real benchmark charts, and recent SOTA publications ($\ge 2023$).
...
- 🛡️ **Zero-Hallucination Guarantee**: Code AST symbols referenced in thesis chapters are verified against physical AST nodes by `CrossConsistencyValidator`.
- ⚡ **Dual-Engine Typesetting**: Instant live editing with modern **Typst 0.11+** alongside rock-solid **LaTeX / Overleaf** export.
- 🔬 **Dynamic SOTA Research**: Automatic discovery of recent, highly cited publications ($\ge 2023$) customized to the exact input topic (36 SOTA Papers).
...
- 🎯 **Code-Thesis Co-Synthesis (PaperCoder 2026)**: Synchronized generation of `src/core/` Python app and 40-80 page thesis.
