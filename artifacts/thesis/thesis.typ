// Typst Thesis Document - Generated by ADK
#set document(title: "System IoT z analizą danych", author: "Autor Projektu")
#set page(paper: "a4", margin: (x: 2.5cm, top: 2.5cm, bottom: 2.5cm))
#set text(font: "Linux Libertine", size: 11pt, lang: "pl")
#set par(justify: true, leading: 0.75em, first-line-indent: 1.25cm)
#set heading(numbering: "1.1")

#align(center)[
  #text(14pt, weight: "bold")[Politechnika / Uczelnia Techniczna]

  #text(12pt)[Wydział Informatyki]

  #v(3cm)
  #text(18pt, weight: "bold")[System IoT z analizą danych]

  #v(2cm)
  #text(12pt, weight: "bold")[Praca Inżynierska]

  #text(11pt)[Kierunek: Informatyka Stosowana]
...
*Autor Projektu*],
    [Promotor:
*dr inż. Promotor Akademicki*]
  )
  #v(2cm)
  #text(11pt)[Warszawa, 2027]
]
#pagebreak()
...
*Słowa kluczowe:* Inżynieria Oprogramowania, Systemy Agentowe, MCP, Ewaluacja Empiryczna, Testowanie
...
= Przegląd literatury i stan wiedzy (SOTA)
...
= Projekt architektury systemu IT
...
= Implementacja i środowisko uruchomieniowe
